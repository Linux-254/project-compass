...
export function OAuthLoadingOverlay() {
  const [pending, setPending] = useState(hasPendingOAuth);
  ...
  return (
    <div
      className="fixed inset-0 z-[100] grid place-items-center bg-background/82 px-6 backdrop-blur-md"
      role="status"
      aria-live="polite"
      aria-label="Connecting to ReForge"
    >
      <div className="nature-card w-full max-w-sm p-8 text-center shadow-2xl shadow-primary/10">
        ...
        <h2 className="mt-3 font-serif text-3xl">A moment to settle in.</h2>
